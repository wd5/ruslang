/* 
 * File:   codecvt_cp866.hpp
 * ?Author: Ustas
 * Author: hoxnox (github.com/hoxnox)
 * Copied from/Source : git://github.com/hoxnox/cyrillic-facets.git
 * Created on 2 Октябрь 2011 г., 23:33
 */

#ifndef CODECVT_CP866_HPP
#define	CODECVT_CP866_HPP
